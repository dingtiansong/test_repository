...
###############################################################
    sentence01 = ['T1','M1','P1','M2','P2']
    correct_set01 = [['T1','M1','P1'],['T1','M2','P2']]
    sentence02 = ['T1','M1','M2','P1','P2']
    correct_set02 = [['T1','M1','P1'],['T1','M2','P2'],['T1','M2','P1'],['T1','M1','P2']]
    sentence03 = ['T1','M1','P1']
    correct_set03 = [['T1','M1','P1']]
    sentence04 = ['M1','T1','P1','P2']
    correct_set04 = [['T1','M1','P1'],['T1','M1','P2']]
    sentence05 = ['T1','M1','P1','M2','P2']
    correct_set05 = [['T1','M1','P1'],['T1','M2','P2']]
    sentence06 = ['T1','P1','M1']
    correct_set06 = [['T1','M1','P1']]
    sentence07 = ['T1','M1','P1','P2']
    correct_set07 = [['T1','M1','P1'],['T1','M1','P2']]
    sentence08 = ['T1','T2','T3','M1','P1']
    correct_set08 = [['T1','M1','P1'],['T2','M1','P1'],['T3','M1','P1']]
    sentence09 = ['T1','T2','T3','T4','M1','P1','P2']
    correct_set09 = [['T1','M1','P1'],['T2','M1','P1'],['T3','M1','P1'],['T4','M1','P1'],['T1','M1','P2'],['T2','M1','P2'],['T3','M1','P2'],['T4','M1','P2']]
    sentence10 = ['T1','M1','P1','M2','P2']
    correct_set10 = [['T1','M1','P1'],['T1','M2','P2']]
    sentence11 = ['T1','M1','P1','P2']
    correct_set11 = [['T1','M1','P1'],['T1','M1','P2']]
    sentence12 = ['T1','M1','P1','M2','P2']
    correct_set12 = [['T1','M1','P1'],['T1','M2','P2']]
    sentence13 = ['T1','M1','P1','P2','P3']
    correct_set13 = [['T1','M1','P1'],['T1','M1','P2'],['T1','M1','P3']]
    sentence14 = ['T1','M1','P1','M2','P2']
    correct_set14 = [['T1','M1','P1'],['T1','M2','P2']]
    sentence15 = ['T1','M1','P1','P2']
    correct_set15 = [['T1','M1','P1'],['T1','M1','P2']]
    sentence16 = ['T1','M1','T2','M2','P1']
    correct_set16 = [['T1','M1','P1'],['T2','M2','P1']]
    sentence17 = ['T1','M1','P1','P2','P3']
    correct_set17 = [['T1','M1','P1'],['T1','M1','P2'],['T1','M1','P3']]
    sentence18 = ['T1','M1','P1','M2','P2']
    correct_set18 = [['T1','M1','P1'],['T1','M2','P2']]
    sentence19 = ['P1','P2','P3','P4','P5','T1','M1']
    correct_set19 = [['P1','T1','M1'],['P2','T1','M1'],['P3','T1','M1'],['P4','T1','M1'],['P5','T1','M1']]
    sentence20 = ['T1','M1','P1','P2']
    correct_set20 = [['P1','T1','M1'],['P2','T1','M1']]
    sentence21 = ['T1','M1','P1','P2']
    correct_set21 = [['P1','T1','M1'],['P2','T1','M1']]
    sentence22 = ['T1','M1','P1','P2','P3']
    correct_set22 = [['P1','T1','M1'],['P2','T1','M1'],['P3','T1','M1']]
    sentence23 = ['T1','M1','P1','P2','P3']
    correct_set23 = [['P1','T1','M1'],['P2','T1','M1'],['P3','T1','M1']]
    sentence24 = ['M1','T1','P1','P2','P3']
    correct_set24 = [['P1','T1','M1'],['P2','T1','M1'],['P3','T1','M1']]
    sentence25 = ['T1','M1','P1','P2']
    correct_set25 = [['P1','T1','M1'],['P2','T1','M1']]
    sentence26 = ['T1','M1','P1','P2']
    correct_set26 = [['P1','T1','M1'],['P2','T1','M1']]
    sentence27 = ['M1','T1','P1']
    correct_set27 = [['P1','T1','M1']]
    sentence28 = ['T1','M1','P1']
    correct_set28 = [['P1','T1','M1']]
    sentence29 = ['T1','M1','M2','P1']
    correct_set29 = [['P1','T1','M1'],['P1','T1','M2']]
    sentence30 = ['T1','M1','P1']
    correct_set30 = [['P1','T1','M1']]
    sentence31 = ['T1','M1','P1']
    correct_set31 = [['P1','T1','M1']]
    sentence32 = ['T1','M1','M2','P1']
    correct_set32 = [['P1','T1','M1'],['P1','T1','M2']]
    sentence33 = ['T1','T2','M1','P1']
    correct_set33 = [['P1','T1','M1'],['P1','T2','M1']]
    sentence34 = ['T1','T2','T3','M1','P1']
    correct_set34 = [['P1','T1','M1'],['P1','T2','M1'],['P1','T3','M1']]
    sentence35 = ['T1','M1','P1','P2']
    correct_set35 = [['P1','T1','M1'],['P2','T1','M1']]
    sentence36 = ['T1','M1','M2','P1','P2']
    correct_set36 = [['P1','T1','M1'],['P2','T1','M1'],['P1','T1','M2'],['P2','T1','M2']]
    sentence37 = ['T1','M1','P1','P2']
    correct_set37 = [['P1','T1','M1'],['P2','T1','M1']]
    sentence38 = ['T1','T2','T3','M1','P1','P2']
    correct_set38 = [['P1','T1','M1'],['P1','T2','M1'],['P1','T3','M1'],['P2','T1','M1'],['P2','T2','M1'],['P2','T3','M1']]
    sentence39 = ['T1','P1','P2','M1']
    correct_set39 = [['P1','T1','M1'],['P2','T1','M1']]
    sentence40 = ['T1','P1','M1','T2','P2','M2']
    ...
    sentence58=['T1','M1','P1','M2','P2']
    correct_set58=[['T1','M1','P1'],['T1','M2','P2']]
     
    sentence59=['T1','M1','P1','M2','P2']
    correct_set59=[['T1','M1','P1'],['T1','M2','P2']]
     
    sentence60=['T1','M1','P1','M2','P2']
    correct_set60=[['T1','M1','P1'],['T1','M2','P2']]
     
    sentence61=['T1','M1','P1','M2','P2']
    correct_set61=[['T1','M1','P1'],['T1','M2','P2']]
     
    sentence62=['T1','M1','P1','M2','P2']
    correct_set62=[['T1','M1','P1'],['T1','M2','P2']]
     
    sentence63=['T1','M1','T2','M2','P1']
    correct_set63=[['T1','M1','P1'],['T2','M2','P1']]
     
    sentence64=['T1','M1','P1','M2','P2']
    correct_set64=[['T1','M1','P1'],['T1','M2','P2']]
     
    sentence65=['T1','P1','M1','T2','P2','M2']
    correct_set65=[['P1','T1','M1'],['P2','T2','M2']]
     
    sentence66=['M1','P1','M2','P2','T1']
    correct_set66=[['P1','T1','M1'],['P2','T1','M2']]
     
     
    sentence67=['T1','M1','P1','M2','P2','M3','P3']
    correct_set67=[['P1','T1','M1'],['P2','T1','M2'],['P3','T1','M3']]
     
     
    sentence68=['T1','M1','T2','M2','P1']
    correct_set68=[['P1','T1','M1'],['P1','T2','M2']]
     
    sentence69=['P1','T1','M1','P2','T2','M2','M3']
    correct_set69=[['P1','T1','M1'],['P2','T2','M2'],['P2','T2','M3']]
     
     
    sentence70=['P1','T1','M1','P2','T2','M2','P3','T3','M3','M4']
    correct_set70=[['P1','T1','M1'],['P2','T2','M2'],['P3','T3','M3'],['P3','T3','M4']]
     
     
    sentence71=['T1','M1','P1','P2','T2','M2','P3','P4']
    correct_set71=[['P1','T1','M1'],['P2','T2','M1'],['P3','T2','M2'],['P4','T2','M2']]
     
     
    sentence72=['T1','M1','P1','M2','P2']
    correct_set72=[['P1','T1','M1'],['P2','T1','M2']]
     
     
    sentence73=['P1','T1','M1','T2','M2']
    correct_set73=[['P1','T1','M1'],['P1','T2','M2']]
     
    sentence74=['T1','M1','P1','M2','P2']
    correct_set74=[['T1','M1','P1'],['T1','M2','P2']]
     
    sentence75=['T1','M1','P1','M2','P2']
    correct_set75=[['T1','M1','P1'],['T1','M2','P2']]
     
    sentence76=['T1','M1','P1','M2','P2']
    correct_set76=[['T1','M1','P1'],['T1','M2','P2']]
     
    sentence77=['T1','M1','P1','M2','P2']
    correct_set77=[['T1','M1','P1'],['T1','M2','P2']]
     
    sentence78=['T1','M1','P1','M2','P2']
    correct_set78=[['T1','M1','P1'],['T1','M2','P2']]
     
    sentence79=['T1','M1','T2','M2','P1']
    correct_set79=[['T1','M1','P1'],['T2','M2','P1']]
     
    sentence80=['T1','M1','P1','M2','P2']
    correct_set80=[['T1','M1','P1'],['T1','M2','P2']]
     
    sentence81=['T1','P1','M1','T2','P2','M2']
    correct_set81=[['P1','T1','M1'],['P2','T2','M2']]
     
    sentence82=['M1','P1','M2','P2','T1']
    correct_set82=[['P1','T1','M1'],['P2','T1','M2']]
     
     
    sentence83=['T1','M1','P1','M2','P2','M3','P3']
    correct_set83=[['P1','T1','M1'],['P2','T1','M2'],['P3','T1','M3']]
     
     
    sentence84=['T1','M1','T2','M2','P1']
    correct_set84=[['P1','T1','M1'],['P1','T2','M2']]
     
    sentence85=['P1','T1','M1','P2','T2','M2','M3']
    correct_set85=[['P1','T1','M1'],['P2','T2','M2'],['P2','T2','M3']]
     
     
    sentence86=['P1','T1','M1','P2','T2','M2','P3','T3','M3','M4']
    correct_set86=[['P1','T1','M1'],['P2','T2','M2'],['P3','T3','M3'],['P3','T3','M4']]
     
     
    sentence87=['T1','M1','P1','P2','T2','M2','P3','P4']
    correct_set87=[['P1','T1','M1'],['P2','T2','M1'],['P3','T2','M2'],['P4','T2','M2']]
     
     
    sentence88=['T1','M1','P1','M2','P2']
    correct_set88=[['P1','T1','M1'],['P2','T1','M2']]
     
     
    sentence89=['P1','T1','M1','T2','M2']
    correct_set89=[['P1','T1','M1'],['P1','T2','M2']]
     
    sentence90=['T1','M1','P1','M2','P2']
    correct_set90=[['T1','M1','P1'],['T1','M2','P2']]
     
    sentence91=['T1','M1','P1','M2','P2']
    correct_set91=[['T1','M1','P1'],['T1','M2','P2']]
     
    sentence92=['T1','M1','P1','M2','P2']
    correct_set92=[['T1','M1','P1'],['T1','M2','P2']]
     
    sentence93=['T1','M1','P1','M2','P2']
    correct_set93=[['T1','M1','P1'],['T1','M2','P2']]
     
    sentence94=['T1','M1','P1','M2','P2']
    correct_set94=[['T1','M1','P1'],['T1','M2','P2']]
     
    sentence95=['T1','M1','T2','M2','P1']
    correct_set95=[['T1','M1','P1'],['T2','M2','P1']]
     
    sentence96=['T1','M1','P1','M2','P2']
    correct_set96=[['T1','M1','P1'],['T1','M2','P2']]
     
    sentence97=['T1','P1','M1','T2','P2','M2']
    correct_set97=[['P1','T1','M1'],['P2','T2','M2']]
     
    sentence98=['M1','P1','M2','P2','T1']
    correct_set98=[['P1','T1','M1'],['P2','T1','M2']]
