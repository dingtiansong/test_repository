...
class entityRelationExtractionModel(object):
    ...
    def __init__(self, params = 5,maxFactor = 50,  list1 = ['D','P','T','R'], list2=['D1','T1','P1','R1','R2'], list3 = [['D1','P1','T1','R1'],['D1','P1','T1','R2']]):
        '''
        Constructor
        '''
        self.english = list1
...
class initializeModel(object):
    ...
    #模型调用函数
    def getEntityRelationResult(self, sentence = '', vType='Online'):
...
#     print tModel.updateDataList(sentence,correct_set, vType)
    print tModel.getEntityRelationResult(sentence0, vType)
#     
#     sentence05=['D1','P1','T1','R1','T2','R2','T3','R3']
#     correct_set05=[['D1','P1','T1','R1'],['D1','P1','T2','R2'],['D1','P1','T3','R3']]
