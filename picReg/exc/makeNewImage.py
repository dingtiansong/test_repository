...
#历史图片数据读取
dataPath = 'D:/picreg/imageData.pkl'
...
#新图片数据读取
filePath='E:/NLP/QDFile/subImagepd15/newImage'
...
#更新图片数据，并输出，进行人工识图
filePath='E:/NLP/QDFile/subImagepd15/trainImage/image'
picId = 0
for tmp in cellSet:
    tImg = np.array(tmp).reshape(20,80)
