...
class cvPredictiveText(object):
    ...
    def __init__(self,tPath = 'D:/picreg/trainData/imageData.pkl',historypath='D:/picreg/trainData/historydata.pkl'):
        if tPath and historypath:
            self.dataPath = tPath
            self.historydatapath=historypath
        history_file=open(self.historydatapath, 'rb')
        self.historydata=pickle.load(history_file)      
        pkl_file = open('D:/picreg/trainData/imageData.pkl', 'rb')
...
#                 n = nLength
    ...
    def getReadImg(self,gray,minValue = 0,mLength=20,nLength = 80,minDist = 2):
        ...
        if len(imgMin) > 0:
            ...
            return ''
        return predictword
def extractionQBImage(imgPath,tPath = 'D:/picreg/trainData/imageData.pkl',t2Path = 'D:/picreg/trainData/historydata.pkl'):
    ...
    cw = cutWordImage()
    cc = compareword()
    cp = cvPredictiveText(tPath,t2Path)
...
#         print len(targetmatrix[1])
    ...
    def compareVector(self,cutpart,targetmatrix,targetindex,transvectorlist): 
#         print targetindex
        wordindex=[]
...
if __name__=='__main__':
    ...
    if len(sys.argv) >= 3:
        ...
        dataPath = 'imageData.pkl'
        imgPath = sys.argv[1]
        strList = extractionQBImage(imgPath,dataPath)
    
    dataPath = 'D:/picreg/trainData/imageData.pkl'
    imgPath = 'D:/picreg/trainData/123.png'
    dataPath2 = 'D:/picreg/trainData/historydata.pkl'
    strList = extractionQBImage(imgPath,dataPath,dataPath2)
